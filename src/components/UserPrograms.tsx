...
import { AppleIcon, ChevronRight, Clock, Dumbbell, ShieldIcon, Sparkles, Users } from "lucide-react"
            ...
            <div className="container mx-auto max-w-6xl px-4">
                ...
                <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
                    ...
                    <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-background">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm text-primary font-medium">Program Gallery</div>
                        </div>
                    ...
                    <div className="p-8 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
                            Explore personalized fitness plan our AI assistant has created for other users
                        </p>
                        {/* STATS */}
                        <div className="flex items-center justify-between gap-16 mt-10 font-mono">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {USER_PROGRAMS.map((program) => (
                        <Card key={program.id} className="bg-card/90 justify-between backdrop-blur-sm border border-border hover:border-primary/50 transition">
                            {/* CARD HEADER WITH USER INFO */}
                            <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-background">
                                <div className="flex items-center gap-2">
                                    <div className="w-2 h-2 rounded-full bg-primary"></div>
                                    <div className="text-sm text-primary">USER.{program.id}</div>
                                </div>
                            ...
                            <CardHeader className="pt-6 px-5">
                                ...
                                <div className="flex justify-between items-center gap-4">
                                    <div className="flex items-center gap-2 px-3 py-1 bg-primary/10 rounded border border-primary/20 text-sm text-primary">
                            ...
                            <CardFooter className="px-5 py-4 border-t border-border">
                                <Link href={`/progams/${program.id}`} className="w-full">
                ...
                <div className="mt-16 text-center">
                    <Link href='/generate-program'>
                        <Button size='sm' className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg">
